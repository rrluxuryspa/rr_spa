...
export default function LearnAboutUsSection({ onOpenBooking }) {
  return (
    <section className="py-20 bg-white border-b border-emerald-200/80 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative w-full flex justify-center">
            <div className="relative w-full max-w-lg aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-emerald-400 group">
              <img
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/95 border border-emerald-300 backdrop-blur-md shadow-lg flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-emerald-gradient flex items-center justify-center text-white font-extrabold text-lg shrink-0 shadow-inner">
                  10+
                </div>
                <div>
                  <h4 className="font-serif text-slate-900 font-bold text-sm">Experience & Trust</h4>
                  <p className="text-xs text-emerald-900 font-bold">RR LUXURY SPA - Manikonda</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-5">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight">
              We Have <span className="text-emerald-800 font-extrabold">10+</span> Years Of Experience
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4 w-full">
              <button
                ...
                className="px-8 py-3.5 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white font-extrabold text-xs tracking-wider uppercase border border-emerald-700 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
              ...
              <a
                ...
                className="px-6 py-3.5 rounded-xl bg-white border border-slate-300 text-slate-800 font-bold text-xs hover:border-emerald-500 hover:text-emerald-900 transition-all flex items-center gap-2 shadow-sm"
              >
